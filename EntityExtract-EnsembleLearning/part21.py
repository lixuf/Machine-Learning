...
def model2():#模型主体2
	...
	return model,crf,model_part_a,model_part_b1

model,crf,model_part_a,model_part_b1=model2()
...
class Evaluator(Callback):
	...
	def on_epoch_end(self,epoch,logs=None):
		...
		if f1>=self.best_val_f1:
			self.best_val_f1=f1
			model_part_b1.save_weights('best_model_model_part_b1.weights')
		print(
